...
<nav class="navbar navbar-expand navbar-dark bg-dark">
    <a href="" class="navbar-brand">CnC</a>
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a href="index.php" class="nav-link">Nazad na stranicu</a>
        </li>
    </ul>
</nav>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <?php if($user->loggedUser): ?>
                <div class="alert alert-success">Uspjesno logovanje <a href="index.php">Idi na stranicu</a></div>
        ...
        <div class="col-6">
            ...
            <input type="text" name="register_name" placeholder="Ime" class="form-control"  required><br>
                ...
                <input type="text" name="register_address" placeholder="Adresa" class="form-control"  required><br>
